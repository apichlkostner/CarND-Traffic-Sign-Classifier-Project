...
* Model Architecture: After a first try with the original LeNet and an improved version with dropout regularization and more layers an architecture from a paper which was created during and after the original challenge was reprogrammed in Tensorflow and used for further analysis
